					...
					<nav class="limiter-menu-desktop container">
						...
						<div class="menu-desktop">
							...
							<ul class="main-menu">
								...
								<li>
									<a href="/productoWeb/index">Medicamento</a>
								</li>
	
								<li class="label1" data-label1="hot">
									<a href="shoping-cart.html">Factura</a>
								</li>
			...
			<div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
				<div class="container-search-header">
					...
					<form class="wrap-search-header flex-w p-l-15">
						...
						<input class="plh3" type="text" name="search" placeholder="!Hola¡ a la orden">
					</form>
				</div>
			</div>
		</header>
					...
					<ul class="header-cart-wrapitem w-full">
						<li class="header-cart-item flex-w flex-t m-b-12">
							<div class="header-cart-item-img">
								<img src="/archivos/item-cart-01.jpg" alt="IMG">
							</div>
						...
						<li class="header-cart-item flex-w flex-t m-b-12">
							<div class="header-cart-item-img">
								<img src="/archivos/item-cart-02.jpg" alt="IMG">
							</div>
						...
						<li class="header-cart-item flex-w flex-t m-b-12">
							<div class="header-cart-item-img">
								<img src="/archivos/item-cart-03.jpg" alt="IMG">
							</div>
		...
		<div class="container">
			...
			<div class="p-t-40">
				...
				<p class="stext-107 cl6 txt-center">
					...
					Copyright &copy;<script>document.write(new Date().getFullYear());</script> Totos los derechos reservados | Colombia-Arjona Bolivar <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Colorlib</a> &amp; distributed by <a href="https://themewagon.com" target="_blank">ThemeWagon</a>
					<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
				</p>
			</div>
		</div>
